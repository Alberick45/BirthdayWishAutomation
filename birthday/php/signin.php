...
//         $passretrieval = "SELECT ru_id,ru_pass,ru_status,ruf_name,rul_name,ru_cntcode,ru_pnum FROM registered_users WHERE ru_name = '$username'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["username"], $_POST["password"])) {
        ...
        $stmt = $conn->prepare("SELECT ru_id, ru_pass, ru_status, ruf_name, rul_name, ru_cntcode, ru_pnum FROM registered_users WHERE ru_name = ?");
